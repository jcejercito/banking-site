...
<html lang="en">
	...
	<body>
		...
		<div class="container align-items-center">
			...
			<form action="backend/form-submit.php" data-type="stafflogin">	
				<div id="form-container" class="container d-flex flex-column justify-content-center">
					<div class="form-text mt-1 mb-4">
					  	...
					  	<input type="text" name="employee_id" class="form-control" id="formGroupExampleInput" placeholder="Employee ID">
					</div>
					<div class="form-text mt-1 mb-4">
